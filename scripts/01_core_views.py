...
CREATE OR REPLACE VIEW core_player_summary AS
...
CREATE OR REPLACE VIEW core_team_summary AS
...
CREATE OR REPLACE VIEW core_rank_latest AS
...
SELECT
    ...
    CASE
        ...
        WHEN r.Rank_After = 17 THEN '07 - Vàng 4'
        WHEN r.Rank_After = 18 THEN '11 - BK 5'
        WHEN r.Rank_After = 19 THEN '12 - BK 4'
        WHEN r.Rank_After = 20 THEN '16 - KC 5'
        WHEN r.Rank_After = 21 THEN '17 - KC 4'
        WHEN r.Rank_After = 22 THEN '21 - Tinh Anh 5'
        WHEN r.Rank_After = 23 THEN '22 - Tinh Anh 4'
        WHEN r.Rank_After = 24 THEN '23 - Tinh Anh 3'
        WHEN r.Rank_After = 25 THEN '24 - Tinh Anh 2'
        WHEN r.Rank_After = 26 THEN '25 - Tinh Anh 1'
        WHEN r.Rank_After = 27 THEN '27 - Chiến Tướng 50*+'
        WHEN r.Rank_After = 28 THEN '26b - Đại Cao Thủ 4'
        WHEN r.Rank_After = 29 THEN '26c - Đại Cao Thủ 3'
        WHEN r.Rank_After = 30 THEN '26d - Đại Cao Thủ 2'
        WHEN r.Rank_After = 31 THEN '26e - Đại Cao Thủ 1'
...
print("Core views created successfully.")